...
class BookCollection:
    ...
    def create_new_book(self):
        ...
        book_description = input("Enter Description: ")
        is_book_read = (
    ...
    def find_book(self):
        ...
        if found_books:
            ...
            for index, book in enumerate(found_books, 1):
                ...
                print(
                    f"{index}. {book['title']} by {book['author']} ({book['year']}) - {book['genre']} - {book['description']} {reading_status}"
                )
        else:
    ...
    def update_book(self):
        ...
        for book in self.book_list:
            if book["title"].lower() == book_title.lower():
                ...
                book["description"] = input(f"New description ({book['description']}): ") or book["description"]
                book["read"] = (
